 ...
 *
 * LOGIN DISABLED FOR NOW — the auto-exchange (web) and deep-link claim (desktop)
 * effect below is commented out so no session can be established. Restore the
 * effect (and its imports) to re-enable login.
 *
