...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {/* Open sidebar → "close" glyph; collapsed sidebar → "open" glyph. */}
