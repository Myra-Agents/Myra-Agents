...
var __dsPreview = (() => {
  ...
  var require_react_shim = __commonJS({
    "shim:react-shim"(exports, module) {
      var R = window.React;
      function jsx2(t, p, k2) {
        return R.createElement(t, k2 === void 0 ? p : Object.assign({ key: k2 }, p));
      }
      module.exports = R;
    ...
    "node_modules/es-toolkit/dist/compat/object/get.js"(exports) {
      ...
      function get6(object, path2, defaultValue) {
        ...
        switch (typeof path2) {
          case "string": {
            ...
            if (result === void 0) if (require_isDeepKey2.isDeepKey(path2)) return get6(object, require_toPath2.toPath(path2), defaultValue);
          ...
          default: {
            ...
            if (Object.is(path2?.valueOf(), -0)) path2 = "-0";
      ...
      function getWithPath(object, path2, defaultValue) {
        ...
        for (let index = 0; index < path2.length; index++) {
          ...
          if (require_isUnsafeProperty2.isUnsafeProperty(path2[index])) return defaultValue;
  ...
  var require_use_sync_external_store_shim_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
      ...
      (function() {
        ...
        var React33 = require_react_shim(), objectIs = "function" === typeof Object.is ? Object.is : is4, useState12 = React33.useState, useEffect18 = React33.useEffect, useLayoutEffect8 = React33.useLayoutEffect, useDebugValue2 = React33.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
  ...
  var require_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React33 = require_react_shim(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = shim.useSyncExternalStore, useRef17 = React33.useRef, useEffect18 = React33.useEffect, useMemo10 = React33.useMemo, useDebugValue2 = React33.useDebugValue;
  ...
  var require_isIterateeCall = __commonJS({
    "node_modules/es-toolkit/dist/compat/_internal/isIterateeCall.js"(exports) {
      ...
      function isIterateeCall(value, index, object) {
        ...
        if (typeof index === "number" && require_isArrayLike2.isArrayLike(object) && require_isIndex2.isIndex(index) && index < object.length || typeof index === "string" && index in object) return require_isEqualsSameValueZero2.isEqualsSameValueZero(object[index], value);
        return false;
      }
  ...
  var require_use_sync_external_store_with_selector_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React33 = require_react_shim(), objectIs = "function" === typeof Object.is ? Object.is : is4, useSyncExternalStore2 = React33.useSyncExternalStore, useRef17 = React33.useRef, useEffect18 = React33.useEffect, useMemo10 = React33.useMemo, useDebugValue2 = React33.useDebugValue;
        exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
          var instRef = useRef17(null);
          if (null === instRef.current) {
            var inst = { hasValue: false, value: null };
  ...
  // .design-sync/previews/ChartTooltipContent.tsx
  var ChartTooltipContent_exports = {};
  __export(ChartTooltipContent_exports, {
...
(See https://redux.js.org/faq/organizing-state#can-i-put-functions-promises-or-other-non-serializable-items-in-my-store-state)`);
  ...
  function usePrefersReducedMotion() {
    var [prefersReducedMotion, setPrefersReducedMotion] = (0, import_react11.useState)(() => {
      if (Global.isSsr) {
        return false;
      }
  ...
  var getPath = (_ref2) => {
    ...
    if (Array.isArray(baseLine)) {
      var _lineFunction;
      var areaPoints = points.map((entry, index) => _objectSpread5(_objectSpread5({}, entry), {}, {
        base: baseLine[index]
      }));
      if (layout === "vertical") {
  ...
  var Curve = (props) => {
    ...
    return /* @__PURE__ */ React7.createElement("path", _extends4({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
  ...
  function createStepperUpdate(from2, to2, easing, interKeys, render, timeoutController) {
    ...
    var stepperUpdate = (now) => {
      ...
      render(_objectSpread7(_objectSpread7(_objectSpread7({}, from2), to2), getCurrStyle()));
      preTime = now;
  ...
  function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
    ...
    var timingStyle = interKeys.reduce((res, key) => {
      ...
      return _objectSpread7(_objectSpread7({}, res), {}, {
    ...
    var timingUpdate = (now) => {
      ...
      render(_objectSpread7(_objectSpread7(_objectSpread7({}, from2), to2), currStyle));
      if (t < 1) {
        stopAnimation = timeoutController.setTimeout(timingUpdate);
      } else {
        var finalStyle = mapObject((key, val) => alpha(...val, easing(1)), timingStyle);
        render(_objectSpread7(_objectSpread7(_objectSpread7({}, from2), to2), finalStyle));
      }
    };
    return () => {
      stopAnimation = timeoutController.setTimeout(timingUpdate);
  ...
  var configUpdate_default = (from2, to2, easing, duration, render, timeoutController) => {
    ...
    if (easing == null) {
      return () => {
        render(_objectSpread7(_objectSpread7({}, from2), to2));
        return () => {
        };
      };
    }
  ...
  // node_modules/recharts/es6/animation/useAnimationManager.js
  var AnimationManagerContext = /* @__PURE__ */ (0, import_react12.createContext)(createDefaultAnimationManager);
  function useAnimationManager(animationId, animationManagerFromProps) {
    var contextAnimationManager = (0, import_react12.useContext)(AnimationManagerContext);
    return (0, import_react12.useMemo)(() => animationManagerFromProps !== null && animationManagerFromProps !== void 0 ? animationManagerFromProps : contextAnimationManager(animationId), [animationId, animationManagerFromProps, contextAnimationManager]);
  }
  ...
  function JavascriptAnimate(outsideProps) {
    ...
    var [style, setStyle] = (0, import_react13.useState)(isActive ? from : to);
    var stopJSAnimation = (0, import_react13.useRef)(null);
  ...
  var Rectangle = (rectangleProps) => {
    ...
    var prevXRef = (0, import_react15.useRef)(x2);
    var prevYRef = (0, import_react15.useRef)(y2);
    ...
    if (!isUpdateAnimationActive) {
      ...
      return /* @__PURE__ */ React8.createElement("path", _extends5({}, otherPathProps, {
        x: round(x2),
        y: round(y2),
        width: round(width),
        height: round(height),
    ...
    return /* @__PURE__ */ React8.createElement(JavascriptAnimate, {
      animationId,
      key: animationId,
      ...
      return /* @__PURE__ */ React8.createElement("path", _extends5({}, otherPathProps2, {
        radius: typeof radius === "number" ? radius : void 0,
        className: layerClass,
        d: getRectanglePath(currX, currY, currWidth, currHeight, radius),
        ref: pathRef,
        style: _objectSpread8(_objectSpread8({}, animationStyle), props.style)
      }));
    });
  };
  ...
  var inRangeOfSector = (_ref5, viewBox) => {
    ...
    if (inRange) {
      return _objectSpread9(_objectSpread9({}, viewBox), {}, {
        radius,
  ...
  var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
    ...
    return _objectSpread10(_objectSpread10({}, implicitAngleAxis), {}, {
      type: evaluatedType
    });
  });
  ...
  var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
    ...
    return _objectSpread10(_objectSpread10({}, implicitRadiusAxis), {}, {
      type: evaluatedType
    });
  });
  ...
  function hslConvert(o) {
    ...
    o = o.rgb();
    var r2 = o.r / 255, g2 = o.g / 255, b = o.b / 255, min2 = Math.min(r2, g2, b), max2 = Math.max(r2, g2, b), h = NaN, s2 = max2 - min2, l = (max2 + min2) / 2;
    if (s2) {
  ...
  var selectSortedDataPoints = createSelector([selectAllAppliedValues], (appliedData) => {
    return appliedData === null || appliedData === void 0 ? void 0 : appliedData.map((item) => item.value).sort(sortBy3);
  });
  ...
  var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
    ...
    return _objectSpread11(_objectSpread11({}, axis), {}, {
      scale
    });
  });
  ...
  var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
    ...
    if (hasBeenActivePreviously(appropriateMouseInteraction)) {
      if (activeFromProps) {
        return _objectSpread12(_objectSpread12({}, appropriateMouseInteraction), {}, {
          active: true
        });
      }
    ...
    return _objectSpread12(_objectSpread12({}, noInteraction), {}, {
    ...
    return tooltipPayloadConfigurations.reduce((agg, _ref2) => {
      ...
      if (Array.isArray(tooltipPayload)) {
        tooltipPayload.forEach((item) => {
          ...
          var newSettings = _objectSpread13(_objectSpread13({}, settings), {}, {
            name: itemName,
  ...
  var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
    ...
    if (entry) {
      if (layout === "centric") {
        ...
        return _objectSpread14(_objectSpread14(_objectSpread14({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
          angle: _angle,
          radius: _radius
        });
      }
      ...
      return _objectSpread14(_objectSpread14(_objectSpread14({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
        angle,
        radius
      });
    }
  ...
  var selectOrderedTooltipTicks = createSelector(selectTooltipAxisTicks, (ticks2) => (0, import_sortBy3.default)(ticks2, (o) => o.coordinate));
  ...
  var seed = {};
  var initialState4 = {
    zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current3) => _objectSpread15(_objectSpread15({}, acc), {}, {
      [current3]: {
        element: void 0,
      ...
      var listener2 = (incomingSyncId, action, emitter) => {
        ...
        if (syncMethod === "index") {
          ...
          if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
            ...
            var scaledCoordinate = _objectSpread16(_objectSpread16({}, otherCoordinateProps), {}, {
              x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
              y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
            });
            dispatch(_objectSpread16(_objectSpread16({}, action), {}, {
              payload: _objectSpread16(_objectSpread16({}, action.payload), {}, {
  ...
  var LRUCache = class {
    constructor(maxSize) {
      _defineProperty17(this, "cache", /* @__PURE__ */ new Map());
  ...
  var currentConfig = _objectSpread17({}, defaultConfig);
  ...
  _defineProperty19(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
  ...
  var Text = /* @__PURE__ */ (0, import_react19.forwardRef)((outsideProps, ref) => {
    ...
    return /* @__PURE__ */ React10.createElement("text", _extends7({}, svgPropertiesAndEvents(textProps), {
      ref,
      x: x2,
      y: y2,
  ...
  var CartesianLabelContextProvider = (_ref2) => {
    ...
    return /* @__PURE__ */ React11.createElement(CartesianLabelContext.Provider, {
      value: viewBox
    }, children);
  };
  ...
  var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
    ...
    return /* @__PURE__ */ React11.createElement("text", _extends8({}, attrs, {
      dominantBaseline: "central",
      className: clsx("recharts-radial-bar-label", className)
    }), /* @__PURE__ */ React11.createElement("defs", null, /* @__PURE__ */ React11.createElement("path", {
      id,
      d: path2
    })), /* @__PURE__ */ React11.createElement("textPath", {
      xlinkHref: "#".concat(id)
    }, label));
  };
  ...
  function Label(outerProps) {
    ...
    var propsWithViewBox = _objectSpread19(_objectSpread19({}, props), {}, {
      viewBox
    });
    ...
    if (isPolar(viewBox)) {
      ...
      positionAttrs = _objectSpread19(_objectSpread19({
        x: cartesianResult.x,
        y: cartesianResult.y,
    ...
    return /* @__PURE__ */ React11.createElement(ZIndexLayer, {
      zIndex: props.zIndex
    }, /* @__PURE__ */ React11.createElement(Text, _extends8({
      ref: labelRef,
  ...
  var parseLabel = (label, viewBox, labelRef) => {
    ...
    if (label === true) {
      return /* @__PURE__ */ React11.createElement(Label, _extends8({
        key: "label-implicit"
      }, commonProps));
    }
    if (isNumOrStr(label)) {
    ...
    if (/* @__PURE__ */ (0, import_react20.isValidElement)(label)) {
      if (label.type === Label) {
        return /* @__PURE__ */ (0, import_react20.cloneElement)(label, _objectSpread19({
          key: "label-implicit"
        }, commonProps));
      }
      return /* @__PURE__ */ React11.createElement(Label, _extends8({
    ...
    if (label && typeof label === "object") {
      return /* @__PURE__ */ React11.createElement(Label, _extends8({}, label, {
        key: "label-implicit"
      }, commonProps));
    }
    return null;
  ...
  function LabelList(_ref2) {
    ...
    return /* @__PURE__ */ React12.createElement(ZIndexLayer, {
    ...
    }, /* @__PURE__ */ React12.createElement(Layer, {
      ...
      return /* @__PURE__ */ React12.createElement(Label, _extends9({
  ...
  function LabelListFromLabelProp(_ref2) {
    ...
    if (label === true) {
      return /* @__PURE__ */ React12.createElement(LabelList, {
        key: "labelList-implicit"
      });
    }
    if (/* @__PURE__ */ React12.isValidElement(label) || isLabelContentAFunction(label)) {
      return /* @__PURE__ */ React12.createElement(LabelList, {
        key: "labelList-implicit",
        content: label
      });
    ...
    if (typeof label === "object") {
      return /* @__PURE__ */ React12.createElement(LabelList, _extends9({
        key: "labelList-implicit"
      }, label, {
  ...
  var Trapezoid = (outsideProps) => {
    ...
    var pathRef = (0, import_react23.useRef)(null);
    var [totalLength, setTotalLength] = (0, import_react23.useState)(-1);
    var prevUpperWidthRef = (0, import_react23.useRef)(upperWidth);
    var prevLowerWidthRef = (0, import_react23.useRef)(lowerWidth);
    var prevHeightRef = (0, import_react23.useRef)(height);
    var prevXRef = (0, import_react23.useRef)(x2);
    var prevYRef = (0, import_react23.useRef)(y2);
    ...
    return /* @__PURE__ */ React13.createElement(JavascriptAnimate, {
      animationId,
      key: animationId,
      canBegin: totalLength > 0,
      duration: animationDuration,
      ...
      return /* @__PURE__ */ React13.createElement("path", _extends10({}, svgPropertiesAndEvents(trapezoidProps), {
        ...
        ref: pathRef,
        style: _objectSpread20(_objectSpread20({}, animationStyle), trapezoidProps.style)
      }));
    });
  };

  // node_modules/recharts/es6/util/ActiveShapeUtils.js
  var _excluded9 = ["option", "shapeType", "activeClassName", "inActiveClassName"];
  ...
  function defaultPropTransformer(option, props) {
    return _objectSpread21(_objectSpread21({}, props), option);
  }
  ...
  function ShapeSelector(_ref2) {
    ...
    switch (shapeType) {
      case "rectangle":
        return /* @__PURE__ */ React14.createElement(Rectangle, elementProps);
      case "trapezoid":
        return /* @__PURE__ */ React14.createElement(Trapezoid, elementProps);
      case "sector":
        return /* @__PURE__ */ React14.createElement(Sector, elementProps);
      case "symbols":
        if (isSymbolsProps(shapeType, elementProps)) {
          return /* @__PURE__ */ React14.createElement(Symbols, elementProps);
        }
        break;
      case "curve":
        return /* @__PURE__ */ React14.createElement(Curve, elementProps);
      default:
        return null;
    }
  }
  ...
  function Shape(_ref2) {
    ...
    } = _ref2, props = _objectWithoutProperties9(_ref2, _excluded9);
    var shape;
    if (/* @__PURE__ */ (0, import_react24.isValidElement)(option)) {
      shape = /* @__PURE__ */ (0, import_react24.cloneElement)(option, _objectSpread21(_objectSpread21({}, props), getPropsFromShapeOption(option)));
      ...
      shape = /* @__PURE__ */ React14.createElement(ShapeSelector, {
        shapeType,
  ...
  function SetTooltipEntrySettings(_ref2) {
    ...
    var dispatch = useAppDispatch();
    var isPanorama = useIsPanorama();
    var prevSettingsRef = (0, import_react25.useRef)(null);
  ...
  function SetLegendPayload(_ref2) {
    ...
    var dispatch = useAppDispatch();
    var isPanorama = useIsPanorama();
    var prevPayloadRef = (0, import_react26.useRef)(null);
  ...
  var _ref;
  var useIdFallback = () => {
    var [id] = React15.useState(() => uniqueId("uid-"));
    return id;
  };
  var useId = (_ref = React15["useId".toString()]) !== null && _ref !== void 0 ? _ref : useIdFallback;
  ...
  // node_modules/recharts/es6/context/RegisterGraphicalItemId.js
  var GraphicalItemIdContext = /* @__PURE__ */ (0, import_react27.createContext)(void 0);
  var RegisterGraphicalItemId = (_ref2) => {
    ...
    return /* @__PURE__ */ React16.createElement(GraphicalItemIdContext.Provider, {
      value: resolvedId
    }, children(resolvedId));
  };
  ...
  var SetCartesianGraphicalItemImpl = (props) => {
    var dispatch = useAppDispatch();
    var prevPropsRef = (0, import_react28.useRef)(null);
  ...
  var SetCartesianGraphicalItem = /* @__PURE__ */ (0, import_react28.memo)(SetCartesianGraphicalItemImpl);
    ...
    reducers: {
      ...
      updateYAxisWidth(state, action) {
        ...
        if (axis) {
          ...
          state.yAxis[id] = _objectSpread22(_objectSpread22({}, axis), {}, {
            width,
  ...
  var combineAllBarPositions = (sizeList, globalMaxBarSize, barGap, barCategoryGap, barBandSize, bandSize, childMaxBarSize) => {
    ...
    if (barBandSize !== bandSize && allBarPositions != null) {
      allBarPositions = allBarPositions.map((pos) => _objectSpread23(_objectSpread23({}, pos), {}, {
        position: _objectSpread23(_objectSpread23({}, pos.position), {}, {
  ...
  function getTicksEnd(sign2, boundaries, getTickSize, ticks2, minTickGap) {
    ...
    var _loop = function _loop2(i2) {
      ...
      if (i2 === len - 1) {
        ...
        result[i2] = entry = _objectSpread24(_objectSpread24({}, entry), {}, {
      ...
      if (entry.tickCoord != null) {
        ...
        if (isShow) {
          ...
          result[i2] = _objectSpread24(_objectSpread24({}, entry), {}, {
            isShow: true
          });
        }
      }
  ...
  function AxisLine(axisLineProps) {
    ...
    var props = _objectSpread25(_objectSpread25(_objectSpread25({}, otherSvgProps), svgPropertiesNoEvents(axisLine)), {}, {
      fill: "none"
    });
    ...
    return /* @__PURE__ */ React18.createElement("line", _extends11({}, props, {
      className: clsx("recharts-cartesian-axis-line", (0, import_get4.default)(axisLine, "className"))
    }));
  }
  function getTickLineCoord(data2, x2, y2, width, height, orientation, tickSize, mirror, tickMargin) {
  ...
  function TickItem(props) {
    ...
    if (/* @__PURE__ */ React18.isValidElement(option)) {
      tickItem = /* @__PURE__ */ React18.cloneElement(option, _objectSpread25(_objectSpread25({}, tickProps), {}, {
        className: combinedClassName
      }));
    } else if (typeof option === "function") {
      tickItem = option(_objectSpread25(_objectSpread25({}, tickProps), {}, {
        className: combinedClassName
      }));
    } else {
      ...
      tickItem = /* @__PURE__ */ React18.createElement(Text, _extends11({}, tickProps, {
        className
      }), value);
    }
    return tickItem;
  ...
  var Ticks = /* @__PURE__ */ (0, import_react31.forwardRef)((props, ref) => {
    var {
      ticks: ticks2 = [],
      tick,
      tickLine,
    ...
    var finalTicks = getTicks(_objectSpread25(_objectSpread25({}, getTicksConfig), {}, {
      ticks: ticks2
    ...
    var tickLineCoords = finalTicks.map((entry) => _objectSpread25({
      entry
    ...
    var tickLines = tickLineCoords.map((_ref2) => {
      ...
      }, tickLine && /* @__PURE__ */ React18.createElement("line", _extends11({}, tickLineProps, lineCoord, {
    ...
    var tickLabels = tickLineCoords.map((_ref3, i) => {
      ...
      var finalTickProps = _objectSpread25(_objectSpread25({}, tickProps), customTickProps);
      return /* @__PURE__ */ React18.createElement(Layer, _extends11({
        className: "recharts-cartesian-axis-tick-label",
        key: "tick-label-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
      }, adaptEventsOfChild(events, entry, i)), tick && /* @__PURE__ */ React18.createElement(TickItem, {
        option: tick,
    ...
    }, /* @__PURE__ */ React18.createElement(RenderedTicksReporter, {
      ticks: finalTicks,
      axisId,
      axisType
    }), tickLabels.length > 0 && /* @__PURE__ */ React18.createElement(ZIndexLayer, {
      zIndex: DefaultZIndexes.label
    }, /* @__PURE__ */ React18.createElement("g", {
      className: "recharts-cartesian-axis-tick-labels recharts-".concat(axisType, "-tick-labels"),
      ref
    }, tickLabels)), tickLines.length > 0 && /* @__PURE__ */ React18.createElement("g", {
      className: "recharts-cartesian-axis-tick-lines recharts-".concat(axisType, "-tick-lines")
    }, tickLines));
  });
  var CartesianAxisComponent = /* @__PURE__ */ (0, import_react31.forwardRef)((props, ref) => {
    var {
      axisLine,
      width,
      height,
    ...
    var [fontSize, setFontSize] = (0, import_react31.useState)("");
    var [letterSpacing, setLetterSpacing] = (0, import_react31.useState)("");
    var tickRefs = (0, import_react31.useRef)(null);
    ...
    var layerRef = (0, import_react31.useCallback)((el) => {
      if (el) {
    ...
    return /* @__PURE__ */ React18.createElement(ZIndexLayer, {
    ...
    }, /* @__PURE__ */ React18.createElement(AxisLine, {
      x: props.x,
      y: props.y,
      width,
      height,
    ...
    }), /* @__PURE__ */ React18.createElement(Ticks, {
      ref: layerRef,
      axisType,
      events: rest,
      fontSize,
      ...
      y: props.y,
      axisId
    }), /* @__PURE__ */ React18.createElement(CartesianLabelContextProvider, {
      x: props.x,
      y: props.y,
      width: props.width,
      height: props.height,
    ...
    }, /* @__PURE__ */ React18.createElement(CartesianLabelFromLabelProp, {
      label: props.label,
      labelRef: props.labelRef
    }), props.children)));
  });
  var CartesianAxis = /* @__PURE__ */ React18.forwardRef((outsideProps, ref) => {
    var props = resolveDefaultProps(outsideProps, defaultCartesianAxisProps);
    return /* @__PURE__ */ React18.createElement(CartesianAxisComponent, _extends11({}, props, {
      ref
    }));
  });
  ...
  function LineItem(_ref2) {
    ...
    var lineItem;
    if (/* @__PURE__ */ React19.isValidElement(option)) {
      lineItem = /* @__PURE__ */ React19.cloneElement(option, lineItemProps);
    } else if (typeof option === "function") {
      ...
      lineItem = /* @__PURE__ */ React19.createElement("line", _extends12({}, restOfFilteredProps, {
        x1,
        y1,
        x2,
        y2,
  ...
  function HorizontalGridLines(props) {
    ...
    var items = horizontalPoints.map((entry, i) => {
      var lineItemProps = _objectSpread26(_objectSpread26({}, otherLineItemProps), {}, {
        x1: x2,
        y1: entry,
        x2: x2 + width,
        y2: entry,
      ...
      return /* @__PURE__ */ React19.createElement(LineItem, {
        key: "line-".concat(i),
        option: horizontal,
        lineItemProps
      });
  ...
  var defaultVerticalCoordinatesGenerator = (_ref3, syncWithTicks) => {
    ...
    return getCoordinatesOfGrid(getTicks(_objectSpread26(_objectSpread26(_objectSpread26({}, defaultCartesianAxisProps), xAxis), {}, {
  ...
  var defaultHorizontalCoordinatesGenerator = (_ref4, syncWithTicks) => {
    ...
    return getCoordinatesOfGrid(getTicks(_objectSpread26(_objectSpread26(_objectSpread26({}, defaultCartesianAxisProps), yAxis), {}, {
  ...
  function CartesianGrid(props) {
    ...
    var propsIncludingDefaults = _objectSpread26(_objectSpread26({}, resolveDefaultProps(props, defaultCartesianGridProps)), {}, {
    ...
    if ((!horizontalPoints || !horizontalPoints.length) && typeof horizontalCoordinatesGenerator === "function") {
      ...
      var generatorResult = horizontalCoordinatesGenerator({
        yAxis: yAxis ? _objectSpread26(_objectSpread26({}, yAxis), {}, {
    ...
    if ((!verticalPoints || !verticalPoints.length) && typeof verticalCoordinatesGenerator === "function") {
      ...
      var _generatorResult = verticalCoordinatesGenerator({
        xAxis: xAxis ? _objectSpread26(_objectSpread26({}, xAxis), {}, {
    ...
    }, /* @__PURE__ */ React19.createElement(Background, {
    ...
    }), /* @__PURE__ */ React19.createElement(HorizontalStripes, _extends12({}, propsIncludingDefaults, {
      horizontalPoints
    })), /* @__PURE__ */ React19.createElement(VerticalStripes, _extends12({}, propsIncludingDefaults, {
      verticalPoints
    })), /* @__PURE__ */ React19.createElement(HorizontalGridLines, _extends12({}, propsIncludingDefaults, {
      offset,
      horizontalPoints,
      xAxis,
      yAxis
    })), /* @__PURE__ */ React19.createElement(VerticalGridLines, _extends12({}, propsIncludingDefaults, {
      offset,
      verticalPoints,
      xAxis,
      yAxis
  ...
  var ErrorBarContext = /* @__PURE__ */ (0, import_react32.createContext)(initialContextState);
  ...
  function BarRectangle(props) {
    return /* @__PURE__ */ React22.createElement(Shape, _extends13({
      shapeType: "rectangle",
  ...
  var BarStackContext = /* @__PURE__ */ (0, import_react33.createContext)(void 0);
  var useStackId = (childStackId) => {
    var stackSettings = (0, import_react33.useContext)(BarStackContext);
  ...
  var useBarStackClipPathUrl = (index) => {
    var barStackContext = (0, import_react33.useContext)(BarStackContext);
  ...
  var BarStackClipLayer = (_ref2) => {
    var {
      index
    } = _ref2, rest = _objectWithoutProperties13(_ref2, _excluded13);
    var clipPathUrl = useBarStackClipPathUrl(index);
    return /* @__PURE__ */ React23.createElement(Layer, _extends14({
  ...
  // node_modules/recharts/es6/cartesian/Bar.js
  var _excluded14 = ["onMouseEnter", "onMouseLeave", "onClick"];
  ...
  var SetBarTooltipEntrySettings = /* @__PURE__ */ React24.memo((_ref2) => {
    var {
      dataKey,
      stroke,
      strokeWidth,
    ...
    return /* @__PURE__ */ React24.createElement(SetTooltipEntrySettings, {
      tooltipEntrySettings
    });
  });
  function BarBackground(props) {
    ...
    } = allOtherBarProps, restOfAllOtherProps = _objectWithoutProperties14(allOtherBarProps, _excluded14);
    ...
    return /* @__PURE__ */ React24.createElement(ZIndexLayer, {
      ...
      var {
        ...
        tooltipPosition
      } = entry, rest = _objectWithoutProperties14(entry, _excluded27);
      ...
      var barRectangleProps = _objectSpread27(_objectSpread27(_objectSpread27(_objectSpread27(_objectSpread27({
      ...
      return /* @__PURE__ */ React24.createElement(BarRectangle, _extends15({
  ...
  function BarLabelListProvider(_ref2) {
    ...
    var labelListEntries = rects === null || rects === void 0 ? void 0 : rects.map((entry) => {
      ...
      return _objectSpread27(_objectSpread27({}, viewBox), {}, {
        value: entry.value,
    ...
    return /* @__PURE__ */ React24.createElement(CartesianLabelListContextProvider, {
  ...
  function BarRectangleWithActiveState(props) {
    ...
    var [stayInLayer, setStayInLayer] = (0, import_react34.useState)(false);
    var [hasMountedActive, setHasMountedActive] = (0, import_react34.useState)(false);
    ...
    var handleTransitionEnd = (0, import_react34.useCallback)(() => {
      if (!isActive) {
    ...
    var content = /* @__PURE__ */ React24.createElement(BarRectangle, _extends15({}, baseProps, {
    ...
    if (shouldRenderInLayer) {
      ...
      }, /* @__PURE__ */ React24.createElement(BarStackClipLayer, {
  ...
  function BarRectangleNeverActive(props) {
    ...
    return /* @__PURE__ */ React24.createElement(BarRectangle, _extends15({}, baseProps, {
      name: String(baseProps.name)
    }, entry, {
      isActive: false,
      option: shape,
  ...
  function BarRectangles(_ref3) {
    ...
    var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      id
    } = _ref4, baseProps = _objectWithoutProperties14(_ref4, _excluded33);
    var {
      shape,
      dataKey,
      activeBar
    ...
    var {
      ...
      onClick: onItemClickFromProps,
      onMouseLeave: onMouseLeaveFromProps
    } = props, restOfAllOtherProps = _objectWithoutProperties14(props, _excluded43);
    ...
    return /* @__PURE__ */ React24.createElement(React24.Fragment, null, data2.map((entry, i) => {
      return /* @__PURE__ */ React24.createElement(BarStackClipLayer, _extends15({
        index: entry.originalDataIndex,
      ...
      }), activeBar ? /* @__PURE__ */ React24.createElement(BarRectangleWithActiveState, {
        shape,
        activeBar,
        baseProps,
        entry,
         ...
         */
        /* @__PURE__ */ React24.createElement(BarRectangleNeverActive, {
          shape,
          baseProps,
          entry,
          index: i,
  ...
  function RectanglesWithAnimation(_ref5) {
    ...
    var [isAnimating, setIsAnimating] = (0, import_react34.useState)(false);
    ...
    return /* @__PURE__ */ React24.createElement(BarLabelListProvider, {
      showLabels,
      rects: data2
    }, /* @__PURE__ */ React24.createElement(JavascriptAnimate, {
      animationId,
      begin: animationBegin,
      duration: animationDuration,
      ...
      var stepData = t === 1 ? data2 : data2 === null || data2 === void 0 ? void 0 : data2.map((entry, index) => {
      ...
      return /* @__PURE__ */ React24.createElement(Layer, null, /* @__PURE__ */ React24.createElement(BarRectangles, {
        props,
        data: stepData
      }));
    }), /* @__PURE__ */ React24.createElement(LabelListFromLabelProp, {
      label: props.label
    }), props.children);
  }
  function RenderRectangles(props) {
    var previousRectanglesRef = (0, import_react34.useRef)(null);
    return /* @__PURE__ */ React24.createElement(RectanglesWithAnimation, {
      previousRectanglesRef,
      props
    });
  }
  ...
  var BarWithState = class extends import_react34.PureComponent {
    render() {
      var {
        hide,
        data: data2,
      ...
      return /* @__PURE__ */ React24.createElement(Layer, {
        className: layerClass,
        id
      }, needClip && /* @__PURE__ */ React24.createElement("defs", null, /* @__PURE__ */ React24.createElement(GraphicalItemClipPath, {
        clipPathId,
        xAxisId,
        yAxisId
      ...
      }, /* @__PURE__ */ React24.createElement(BarBackground, {
        data: data2,
        dataKey,
        background,
        allOtherBarProps: this.props
      }), /* @__PURE__ */ React24.createElement(RenderRectangles, this.props)));
    }
  };
  var defaultBarProps = {
    activeBar: false,
  ...
  function BarImpl(props) {
    ...
    return /* @__PURE__ */ React24.createElement(SetErrorBarContext, {
      xAxisId,
      yAxisId,
      data: rects,
      dataPointFormatter: errorBarDataPointFormatter,
      errorBarOffset
    }, /* @__PURE__ */ React24.createElement(BarWithState, _extends15({}, props, {
      layout,
      needClip,
      data: rects,
      xAxisId,
  ...
  function computeBarRectangles(_ref6) {
    ...
    return displayedData.map((entry, index) => {
      ...
      var barRectangleItem = _objectSpread27(_objectSpread27({}, entry), {}, {
        stackedBarStart,
        x: x2,
        y: y2,
        width,
  ...
  function BarFn(outsideProps) {
    ...
    var isPanorama = useIsPanorama();
    return /* @__PURE__ */ React24.createElement(RegisterGraphicalItemId, {
      id: props.id,
      type: "bar"
    }, (id) => /* @__PURE__ */ React24.createElement(React24.Fragment, null, /* @__PURE__ */ React24.createElement(SetLegendPayload, {
      legendPayload: computeLegendPayloadFromBarData(props)
    }), /* @__PURE__ */ React24.createElement(SetBarTooltipEntrySettings, {
      ...
      id
    }), /* @__PURE__ */ React24.createElement(SetCartesianGraphicalItem, {
      type: "bar",
      id,
      data: void 0,
    ...
    }), /* @__PURE__ */ React24.createElement(ZIndexLayer, {
      zIndex: props.zIndex
    }, /* @__PURE__ */ React24.createElement(BarImpl, _extends15({}, props, {
      id
    })))));
  }
  var Bar = /* @__PURE__ */ React24.memo(BarFn, propsAreEqual);
  Bar.displayName = "Bar";
  ...
  function axisPropsAreEqual(prevProps, nextProps) {
    ...
    var {
      domain: nextDomain,
      range: nextRange
    } = nextProps, nextRest = _objectWithoutProperties15(nextProps, _excluded28);
  ...
  function SetXAxisSettings(props) {
    var dispatch = useAppDispatch();
    var prevSettingsRef = (0, import_react35.useRef)(null);
    var layout = useCartesianChartLayout();
    var {
      type: typeFromProps
    } = props, restProps = _objectWithoutProperties16(props, _excluded16);
    var evaluatedType = getAxisTypeBasedOnLayout(layout, "xAxis", typeFromProps);
    var settings = (0, import_react35.useMemo)(() => {
      if (evaluatedType == null) {
        return void 0;
      }
      return _objectSpread28(_objectSpread28({}, restProps), {}, {
        type: evaluatedType
      });
  ...
  var XAxisImpl = (props) => {
    ...
    var {
      ...
      ticks: ticks2,
      scale: del
    } = props, allOtherProps = _objectWithoutProperties16(props, _excluded29);
    var {
      id,
      scale: del2
    } = synchronizedSettings, restSynchronizedSettings = _objectWithoutProperties16(synchronizedSettings, _excluded34);
    return /* @__PURE__ */ React25.createElement(CartesianAxis, _extends16({}, allOtherProps, restSynchronizedSettings, {
      x: position.x,
      y: position.y,
  ...
  var XAxisSettingsDispatcher = (outsideProps) => {
    ...
    return /* @__PURE__ */ React25.createElement(React25.Fragment, null, /* @__PURE__ */ React25.createElement(SetXAxisSettings, {
    ...
    }), /* @__PURE__ */ React25.createElement(XAxisImpl, props));
  };
  var XAxis = /* @__PURE__ */ React25.memo(XAxisSettingsDispatcher, axisPropsAreEqual);
  ...
  function RechartsStoreProvider(_ref2) {
    ...
    return /* @__PURE__ */ React26.createElement(Provider_default, {
  ...
  var ReportMainChartProps = /* @__PURE__ */ (0, import_react37.memo)(ReportMainChartPropsImpl, propsAreEqual);
  ...
  var ReportEventSettings = /* @__PURE__ */ (0, import_react39.memo)(ReportEventSettingsImpl, propsAreEqual);
  ...
  function AllZIndexPortals(_ref2) {
    ...
    return /* @__PURE__ */ React27.createElement(React27.Fragment, null, allNegativeZIndexes.map((zIndex) => /* @__PURE__ */ React27.createElement(ZIndexSvgPortal, {
      key: zIndex,
      zIndex,
      isPanorama
    })), children, allPositiveZIndexes.map((zIndex) => /* @__PURE__ */ React27.createElement(ZIndexSvgPortal, {
      key: zIndex,
      zIndex,
      isPanorama
    })));
  ...
  var MainChartSurface = /* @__PURE__ */ (0, import_react41.forwardRef)((props, ref) => {
    ...
    return /* @__PURE__ */ React28.createElement(Surface, _extends17({}, otherAttributes, {
      title,
      desc,
      role,
      tabIndex,
  ...
  var BrushPanoramaSurface = (_ref2) => {
    ...
    return /* @__PURE__ */ React28.createElement(Surface, {
      width,
      height,
      x: x2,
      y: y2
  ...
  var RootSurface = /* @__PURE__ */ (0, import_react41.forwardRef)((_ref2, ref) => {
    var {
      children
    } = _ref2, rest = _objectWithoutProperties17(_ref2, _excluded17);
    var isPanorama = useIsPanorama();
    if (isPanorama) {
      return /* @__PURE__ */ React28.createElement(BrushPanoramaSurface, null, /* @__PURE__ */ React28.createElement(AllZIndexPortals, {
        isPanorama: true
      }, children));
    }
    return /* @__PURE__ */ React28.createElement(MainChartSurface, _extends17({
      ref
    }, rest), /* @__PURE__ */ React28.createElement(AllZIndexPortals, {
      isPanorama: false
    }, children));
  });
  ...
  function useReportScale() {
    var dispatch = useAppDispatch();
    var [ref, setRef] = (0, import_react42.useState)(null);
  ...
  var ResponsiveDiv = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var _props$style, _props$style2;
    var observerRef = (0, import_react43.useRef)(null);
    var [sizes, setSizes] = (0, import_react43.useState)({
    ...
    var setContainerSize = (0, import_react43.useCallback)((newWidth, newHeight) => {
      setSizes((prevState) => {
    ...
    var innerRef = (0, import_react43.useCallback)((node) => {
    ...
    return /* @__PURE__ */ React29.createElement(React29.Fragment, null, /* @__PURE__ */ React29.createElement(ReportChartSize, {
      width: sizes.containerWidth,
      height: sizes.containerHeight
    }), /* @__PURE__ */ React29.createElement("div", _extends18({
      ref: innerRef
    }, props)));
  });
  var ReadSizeOnceDiv = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var {
      width,
      height
    } = props;
  ...
  var StaticDiv = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var {
      width,
      height
    } = props;
  ...
  var NonResponsiveDiv = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var {
      width,
      height
    } = props;
    if (typeof width === "string" || typeof height === "string") {
      return /* @__PURE__ */ React29.createElement(ReadSizeOnceDiv, _extends18({}, props, {
        ref
      }));
    }
    if (typeof width === "number" && typeof height === "number") {
      return /* @__PURE__ */ React29.createElement(StaticDiv, _extends18({}, props, {
        width,
        height,
        ref
      }));
  ...
  var RechartsWrapper = /* @__PURE__ */ (0, import_react43.forwardRef)((props, ref) => {
    var {
      children,
      className,
      height: heightFromProps,
    ...
    var dispatch = useAppDispatch();
    var [tooltipPortal, setTooltipPortal] = (0, import_react43.useState)(null);
    var [legendPortal, setLegendPortal] = (0, import_react43.useState)(null);
    ...
    var myOnClick = (0, import_react43.useCallback)((e) => {
    ...
    var myOnMouseEnter = (0, import_react43.useCallback)((e) => {
    ...
    var myOnMouseLeave = (0, import_react43.useCallback)((e) => {
    ...
    var myOnMouseMove = (0, import_react43.useCallback)((e) => {
      dispatch(mouseMoveAction(e));
      dispatch(externalEventAction({
        handler: onMouseMove,
        reactEvent: e
    ...
    var onFocus = (0, import_react43.useCallback)(() => {
      dispatch(focusAction());
    }, [dispatch]);
    var onBlur = (0, import_react43.useCallback)(() => {
      dispatch(blurAction());
    }, [dispatch]);
    var onKeyDown = (0, import_react43.useCallback)((e) => {
      dispatch(keyDownAction(e.key));
    }, [dispatch]);
    var myOnContextMenu = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onContextMenu,
        reactEvent: e
      }));
    }, [dispatch, onContextMenu]);
    var myOnDoubleClick = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onDoubleClick,
        reactEvent: e
      }));
    }, [dispatch, onDoubleClick]);
    var myOnMouseDown = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onMouseDown,
        reactEvent: e
      }));
    }, [dispatch, onMouseDown]);
    var myOnMouseUp = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onMouseUp,
        reactEvent: e
      }));
    }, [dispatch, onMouseUp]);
    var myOnTouchStart = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onTouchStart,
        reactEvent: e
      }));
    }, [dispatch, onTouchStart]);
    var myOnTouchMove = (0, import_react43.useCallback)((e) => {
    ...
    var myOnTouchEnd = (0, import_react43.useCallback)((e) => {
      dispatch(externalEventAction({
        handler: onTouchEnd,
        reactEvent: e
      }));
    ...
    return /* @__PURE__ */ React29.createElement(TooltipPortalContext.Provider, {
      value: tooltipPortal
    }, /* @__PURE__ */ React29.createElement(LegendPortalContext.Provider, {
      value: legendPortal
    }, /* @__PURE__ */ React29.createElement(WrapperDiv, {
      ...
      ref: innerRef
    }, /* @__PURE__ */ React29.createElement(EventSynchronizer, null), children)));
  });
  ...
  var CategoricalChart = /* @__PURE__ */ (0, import_react44.forwardRef)((props, ref) => {
    var {
      width,
      height,
      responsive,
    ...
    if (compact) {
      return /* @__PURE__ */ React30.createElement(React30.Fragment, null, /* @__PURE__ */ React30.createElement(ReportChartSize, {
        width,
        height
      }), /* @__PURE__ */ React30.createElement(RootSurface, {
        otherAttributes: attrs,
        title,
        desc
      }, children));
    }
    return /* @__PURE__ */ React30.createElement(RechartsWrapper, {
      className,
      style,
      width,
      height,
      ...
      desc,
      ref
    }, /* @__PURE__ */ React30.createElement(ClipPathProvider, null, children)));
  });
  ...
  var defaultCartesianChartProps = _objectSpread30({
    accessibilityLayer: true,
    barCategoryGap: "10%",
    barGap: 4,
    layout: "horizontal",
  ...
  var CartesianChart = /* @__PURE__ */ (0, import_react45.forwardRef)(function CartesianChart2(props, ref) {
    ...
    return /* @__PURE__ */ React31.createElement(RechartsStoreProvider, {
      preloadedState: {
        options
      },
      reduxStoreName: (_categoricalChartProp = categoricalChartProps.id) !== null && _categoricalChartProp !== void 0 ? _categoricalChartProp : chartName
    }, /* @__PURE__ */ React31.createElement(ChartDataContextProvider, {
      chartData: categoricalChartProps.data
    }), /* @__PURE__ */ React31.createElement(ReportMainChartProps, {
      layout: rootChartProps.layout,
      margin: rootChartProps.margin
    }), /* @__PURE__ */ React31.createElement(ReportEventSettings, {
      throttleDelay: rootChartProps.throttleDelay,
      throttledEvents: rootChartProps.throttledEvents
    }), /* @__PURE__ */ React31.createElement(ReportChartProps, {
    ...
    }), /* @__PURE__ */ React31.createElement(CategoricalChart, _extends19({}, rootChartProps, {
      ref
    })));
  });
  ...
  var BarChart = /* @__PURE__ */ (0, import_react46.forwardRef)((props, ref) => {
    return /* @__PURE__ */ React32.createElement(CartesianChart, {
      chartName: "BarChart",
      defaultTooltipEventType: "axis",
  ...
  function RunsPerDay() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.ChartContainer,
      {
        config,
        className: "!aspect-auto",
        style: { width: 440, height: 260 },
        initialDimension: { width: 440, height: 260 },
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, { data, width: 440, height: 260, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartesianGrid, { vertical: false }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XAxis, { dataKey: "day", tickLine: false, axisLine: false, tickMargin: 8 }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltip, { defaultIndex: 3, content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltipContent, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartLegend, { content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartLegendContent, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "done", fill: "var(--color-done)", radius: 4, isAnimationActive: false }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "failed", fill: "var(--color-failed)", radius: 4, isAnimationActive: false })
        ] })
      }
    );
  }
  return __toCommonJS(ChartTooltipContent_exports);
})();
