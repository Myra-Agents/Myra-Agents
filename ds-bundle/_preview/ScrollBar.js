...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ScrollBar.tsx
  ...
  function RunLog() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ScrollArea, { className: "h-40 w-80 rounded-md border", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-3 font-mono text-xs leading-relaxed", children: lines.concat(lines).map((l, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: l }, i)) }) });
  }
  return __toCommonJS(ScrollBar_exports);
})();
